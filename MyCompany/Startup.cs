...
namespace MyCompany
{
    public class Startup
    {
        ...
        {
            //подклюаем конфиг из appsettings.json
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //в процессе разработки вам нам важно видеть подробную информацию об ошибках
            if (env.IsDevelopment())
                app.UseDeveloperExceptionPage();

            //подключаем систему статичных файлов в прилложении (css, js и т.д.)
            app.UseStaticFiles();
